"""
Django settings for getsvgicons project.
...
SECRET_KEY = 'django-insecure-a9yo578rk!^ui5^9r2nv!f5b645-r6+ud3i-i(9e-qdk&@g5zo'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'home.context_processors.recent',
            ],
        },
    },
]

WSGI_APPLICATION = 'getsvgicons.wsgi.application'
